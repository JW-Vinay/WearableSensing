...
//    					String gentext1 = "Battery is "+GPInfoPacket.GetBatteryStatus(msg.getBytes())+"\n"; 
...
//						System.out.println("Heart Rate: " + SummaryInfoPacket.GetHeartRate(msg.getBytes()));
//						System.out.println("Respiration Rate: " + SummaryInfoPacket.GetRespirationRate(msg.getBytes()));
